...
class transaction_production extends CI_Controller
{
    ...
    public function save_transaction()
    {
        ...
        if ($this->Transaction_model->check_order_product()) {
            $this->Transaction_model->save_transaction($this->input->post(), 'production', 'productionPrice');
    ...
    public function save_transaction_update()
    {
        ...
        if ($this->Transaction_model->check_order_product()) {
            // var_dump($this->input->post());
            // die;
            $this->Transaction_model->save_transaction_update($this->input->post(), 'production', 'productionPrice');
            $this->session->keep_flashdata('idOrder');
            $this->session->keep_flashdata('buyerName');
            $this->session->keep_flashdata('buyerAddress');
            $this->session->keep_flashdata('buyerPhone');
    ...
    public function update_transaction()
    {
        ...
        if ($this->Transaction_model->check_order_product()) {
            $this->Transaction_model->save_transaction($this->input->post(), 'production', 'sellingPrice');
            $this->session->keep_flashdata('buyerName');
            $this->session->keep_flashdata('buyerAddress');
            $this->session->keep_flashdata('buyerPhone');
            $this->session->keep_flashdata('bankAccountNumber');
