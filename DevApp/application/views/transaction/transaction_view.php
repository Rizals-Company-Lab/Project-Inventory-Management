...
<a class="rounded-md w-full sm:py-5 hover:bg-blue-800 flex justify-center items-center sm:mb-5 sm:mt-3 sm:ml-3 ml-3 mr-3 mt-3 py-3 px-3 bg-dark"
    ...
    <div class="sm:flex sm:justify-evenly mt-3 sm:-mt-2 mb-0 sm:mb-5">
        <form class="sm:ml-3 ml-5 sm:mr-0 sm:mb-0 mb-3 mr-5" action="<?= base_url('Transaction/index') ?>"
            method="post">
            <div class="flex justify-between sm:w-full">
                <div>
                    ...
                    <br>
                    <select
                        class="sm:mt-2 sm:mb-4 cursor-pointer sm:w-[200px] h-[40px] border text-black w-full px-10 sm:px-3  rounded-md shadow-md"
