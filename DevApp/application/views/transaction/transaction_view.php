...
<div class="h-auto w-full overflow-x-auto  sm:ml-5 sm:mr-5 rounded-md shadow-sm  ">
        ...
        <div>
            <a class="bg-dark text-white ml-3 sm:text-xl text-sm hover:bg-slate-600 px-3 py-2 rounded-md"
                href="<?php echo site_url('transaction/add_new_transaction');?>"><i
                    class="fa-sharp fa-solid fa-cart-plus"></i> TAMBAH TRANSAKSI</a>
        </div>
    </div>
    <table class="w-full mt-5">
        <div class="p-3 bg-dark">
            ...
            <tbody class="">
                <tr
                    class="cursor-pointer text-center bg-white py-2 group-hover:text-white hover:bg-slate-400 duration-300 group">
                    <th class="kolomhover"><?= $count; ?></th>
                    <td class="kolomhover "><?= $singleView->buyerName ?></td>
                    <td class="kolomhover  "><?= $singleView->orderTimestamp ?></td>
                    <td class="kolomhover ">
