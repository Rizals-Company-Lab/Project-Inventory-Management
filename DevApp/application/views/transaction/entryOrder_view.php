            ...
            <form
                ...
                <div class="sm:flex w-full justify-between mb-5 sm:mt-3">
                    ...
                    <div class="sm:ml-3">
                        ...
                        <input class="mt-2 w-full  py-2 border text-black px-5  rounded-md shadow-md"
                            placeholder="Input Nominal" required type="number" name="ongkir" id="ongkir" min="0"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <input type="hidden" name="sellingPrice<?= $row->idCheckout ?>"
                                                id="sellingPrice<?= $row->idCheckout ?>"
                                        ...
                                        id="productName<?= $row->productName ?>" value="<?= $row->productName ?>"> -->
                                            ...
                                            <td class="border px-3 py-2 shadow-sm">
                                                ...
                                                <button
                                                    class="bg-blue-700 rounded-md text-white px-5 py-1 shadow-md hover:bg-blue-900"
                                                    type="button"
                                                    onclick="deleteDataPesan('<?= $row->SKU ?>')">-</button>
                                            </td>
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            if (response === 'sudah') {
                ...
                document.forms[0]
            .submit(); // Ganti 0 dengan indeks formulir yang sesuai jika ada lebih dari satu formulir
            } else {
