                    ...
                    <tbody>
                        ...
                        <tr
                            ...
                            <input type="hidden" name="distributorPrice<?= $row->idCheckout ?>"
                                id="distributorPrice<?= $row->idCheckout ?>" value="<?= $row->distributorPrice ?>">
                            ...
                            <td class="py-3 w-auto">
                                ...
                                <input
                                    class="peer text-black block min-h-[auto] w-full text-base rounded  border-2 bg-white px-3 py-3 leading-[1.6] outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 peer-focus:text-primary data-[te-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none dark:text-black dark:peer-focus:text-primary [&:not([data-te-input-placeholder-active])]:placeholder:opacity-0"
