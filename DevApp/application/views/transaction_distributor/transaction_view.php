        ...
        <div>
            <a class="bg-dark text-white ml-3 sm:text-xl text-sm hover:bg-slate-600 px-3 py-2 rounded-md"
                href="<?php echo site_url('transaction_distributor/add_new_transaction'); ?>"><i
                    class="fa-sharp fa-solid fa-cart-plus"></i> TAMBAH TRANSAKSI DISTRIBUTOR</a>
        </div>
    </div>
                ...
                <tbody class="">
                    <tr
                        ...
                        <td class=" p-1 text-white flex justify-evenly mt-1">
                            ...
                            <form action="<?= site_url('transaction_distributor/order_detail'); ?>" method="post">
                            ...
                            <form action="<?= site_url('transaction_distributor/get_update'); ?>" method="post">
                                <button type="submit" value="<?= $singleView->idOrder ?>" name="idOrder" id="idOrder"
                                    class="bg-lime-500 rounded-md px-3 py-1 shadow-md hover:bg-green-700"><i
                                        class="fa-regular fa-pen-to-square"></i> Update</button>
                            </form>
                            <form action="<?= site_url('transaction_distributor/delete_order'); ?>" method="post">
                                <button type="submit" value="<?= $singleView->idOrder ?>" name="idOrder" id="idOrder"
