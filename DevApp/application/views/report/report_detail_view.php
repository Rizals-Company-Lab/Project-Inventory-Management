...
<body class="bg-slate-200">
    <div class="sm:flex">
        ...
        <div class="h-auto w-full  sm:ml-5 sm:mr-5 rounded-md shadow-sm  ">
            ...
            <form method="post" action="<?= site_url('report/details'); ?>">
                <label for="dateStart">Start Date:</label>
                <input type="date" name="dateStart" value="<?= (isset($dateStart)) ? $dateStart : '' ?>" id="dateStart">

                <label for="dateEnd">End Date:</label>
                <input type="date" name="dateEnd" value="<?= (isset($dateEnd)) ? $dateEnd : '' ?>" id="dateEnd">

                <button type="submit" value="search" id="search" name="search">Submit</button>
            </form>
                    ...
                    <div class="p-3 w-full sm:bg-dark">
                        <thead class="bg-blue-400">
                            <tr class="text-[12px] sm:text-lg">
                                <th class="py-3" colspan="2">Kolakan </th>
                            </tr>
                        </thead>
                        <thead class="bg-blue-400">
                            <tr class="text-[12px] sm:text-lg">
                        ...
                        <tbody>
                            <tr
                                ...
                                <td class="py-3 w-auto">
                                    <?= $grandTotalPurcase->grandTotalQtyPurcase ?>
                                </td>
                                <td class="py-3 w-auto">
                                    <?= $grandTotalPurcase->grandTotalPricePurcaseAmount ?>
                                </td>
            ...
            <div class="overflow-x-scroll">
                <table class=" w-[900px] text-center  sm:w-full sm:mt-5">
                    <div class="p-3 w-full sm:bg-dark">
                        <thead class="bg-blue-400">
                            <tr class="text-[12px] sm:text-lg">
                                <th class="py-3" colspan="2">PENJUALAN </th>
                            </tr>
                        </thead>
                        <thead class="bg-blue-400">
                            <tr class="text-[12px] sm:text-lg">
                        ...
                        <tbody>
                            <tr
                                ...
                                <td class="py-3 w-auto">
                                    <?= $grandTotalOrder->grandTotalQtyOrder ?>
                                </td>
                                <td class="py-3 w-auto">
                                    <?= $grandTotalOrder->grandTotalPriceOrderAmount ?>
                                </td>
